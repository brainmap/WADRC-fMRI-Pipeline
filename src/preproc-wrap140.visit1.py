...
################### TO ADAPT THEM TO YOUR OWN PROJECT. #########################
    protocolName = 'wrap140.visit1'
    protocolDesc = 'WRAP140 First Visit With CMS Words Task and 195/165 Rest'
    studyName = None
    studyPrefix = 'wrp'
    studyFunctionalFormat = 'dicoms'
    studyRawDir = '/Data/vtrak1/raw/wrap140'
    studyPreprocDir = '/Data/vtrak1/preprocessed/visits/wrap140.visit1'
    studyStatsDir = '/Data/vtrak1/preprocessed/visits/wrap140.visit1'
    studyOnsetsDir = None
    studyTemplatesDir = '/Data/vtrak1/preprocessed/progs/wrap140.visit1/EqualLengthRestTemplates'
...
subjStatsDir = os.path.join(StudyVariables.studyStatsDir, subid, 'stats_basic')

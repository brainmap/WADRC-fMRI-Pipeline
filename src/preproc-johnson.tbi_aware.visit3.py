...
################### TO ADAPT THEM TO YOUR OWN PROJECT. #########################
	protocolName = 'johnson.tbi_aware.visit3'
	protocolDesc = '3rd Timepoint (4 year returners) for Sterlings TBI Study.'
	studyName = None
	studyPrefix = 'tbi'
	studyFunctionalFormat = 'dicoms'
	studyRawDir = '/Data/vtrak1/raw/tbi_aware'
	studyPreprocDir = '/Data/vtrak1/preprocessed/visits/johnson.tbi_aware.visit3'
	studyStatsDir = '/Data/vtrak1/preprocessed/visits/johnson.tbi_aware.visit3'
	studyOnsetsDir = None
	studyTemplatesDir = '/Data/vtrak1/preprocessed/progs/johnson.tbi_aware.visit3/templates'

	realignJobFile = 'johnson.tbi_aware.visit3_realign.mat'
	realignTemplateSubid = 'tbi003_3'
	realignTemplatePreprocDir = '/Data/tmp'
	realignTemplateRuns = []
	realignTemplateFM = False

	normJobFile = 'johnson.tbi_aware.visit3_norm.mat'
	normTemplateSubid = 'tbi003_3'
	normTemplatePreprocDir = '/Data/tmp'
	normTemplateRuns = []
	normTemplateFM = False

	statsJobFile = 'ries.aware.visit1_stats.mat'
	statsTemplateSubid = 'tbi003_3'
	statsTemplatePreprocDir = '/Data/vtrak1/preprocessed/visits/johnson.tbi_aware.visit3'
	statsTemplateStatsDir = '/Data/vtrak1/preprocessed/visits/johnson.tbi_aware.visit3'
...
"""Preprocess a subject for Sterling's TBI 3rd Visit Awareness Study

preproc-johnson.tbi_aware.visit3.py <subject ID> [pipe options]
"""
